...
print("""------------------------------------------
Exercício 9 - Distribuição Energia Elétrica com AGM: 
------------------------------------------""")

cidades = ["SP", "RJ", "BH", "BSB", "FLN", "POA"]

g = PrimGrafo(cidades)

arestas = [
    ("SP", "RJ", 4), ("SP", "BH", 2), ("RJ", "BH", 5),
    ("RJ", "BSB", 10), ("BH", "BSB", 8), ("BH", "FLN", 3),
    ("BSB", "FLN", 7), ("BSB", "POA", 6), ("FLN", "POA", 1)
]
